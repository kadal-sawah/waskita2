...
{
    public $table = "pangkat as p";
    public $table1 = "pangkat";
    public $column_order = array(null, 'nama_pangkat'); //field yang ada di table 
    public $column_search = array('nama_pangkat'); //field yang diizin untuk pencarian 
    public $order = array('id_pangkat' => 'desc'); // default order 
    ...
    {
        $this->db->select('p.id_pangkat, p.nama_pangkat');
    ...
    function get($id)
    {
        return $this->db->get_where($this->table1, array('sha1(id_pangkat)' => $id))->row();
    }
