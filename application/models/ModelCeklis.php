...
class ModelCeklis extends CI_Model
{
    public $table = "ceklis as c";
    public $table1 = "  ceklis";
    public $column_order = array(null, 'nama_ceklis'); //field yang ada di table 
    public $column_search = array('nama_ceklis'); //field yang diizin untuk pencarian 
    public $order = array('id_ceklis' => 'desc'); // default order 
    ...
    function get($id)
    {
        return $this->db->get_where($this->table1, array('sha1(id_ceklis)' => $id))->row();
    }
