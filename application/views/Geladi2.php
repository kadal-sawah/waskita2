                    ...
                    <table class="table-sm table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="bg-yellow text-center montserrat-500 text-size-9">
                                <?= number_format($list['nilai_produk'], 2) ?></td>
                            <td class="bg-light text-center montserrat-500 text-size-9 produk80">
                                <?= number_format($list['nilai_produk'] * 0.8, 2) ?></td>
                            <td class="bg-yellow text-center montserrat-500 text-size-9 ">
                            ...
                            <td class="bg-info text-size-5 text-center text-light montserrat-600  convert-akhir">
                                I</td>
...
for(let i = 0; i<nilAkhir.length; i++){
    ...
    grandtotal = ((nilaiproduk + nilaiposko + nilaiaktivitas + nilaitelepon + nilaitelegram) /2).toFixed(2);
    nilAkhir.eq(i).text(grandtotal);
