                ...
                <form id="formAddKelompok">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <input type="text" class="form-control" name="nama_Kelompok" placeholder="KOGAB" required>
                        </div>
                        <!-- /Nama Kelompok -->
            ...
            <div class="modal-body my-1">
                ...
                <form id="formEditKelompok">
                    <div class="row">
                        ...
                        <div class="col-lg-2"></div>
                        <div class="col-lg-8">
                            <input type="hidden" name="id_kelompok" id="idData">
                            <label class="form-label">Nama Kelompok</label>
...
$('#DTKelompok').on('click', '#edit', function() {
    let id = $(this).data('id');
    $.ajax({
        ...
        success: function(result) {
            ...
            $("#idData").val(response.id_kelompok)
            $("#nama_kelompok").val(response.nama_kelompok)
...
$('#DTKelompok').on('click', '#delete', function() {
    let id = $(this).data('id');
